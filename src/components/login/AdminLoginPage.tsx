    ...
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-top-8 duration-700">
        ...
        <div className="bg-white/90 dark:bg-brand-dark/80 backdrop-blur-xl rounded-[2.5rem] p-10 shadow-2xl border border-white/20">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-[10px] font-black uppercase tracking-widest mb-8">Secure Authorization Protocol</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="block text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em] ml-1">Secret Key</label>
